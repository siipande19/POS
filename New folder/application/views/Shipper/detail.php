<div class="container-fluid">
	<div class="card shadow mb-4 ml-3 mr-3">
        <div class="card-header py-3">
            <h4 class="m-0 font-weight-bold text-primary">Detail Data Shipper</h4>
        </div>
      <div class="card-body">
		<table class="table">
			<tr>
				<th>ID Shipper</th>
				<td><?php echo $detail->id_shipper ?></td>
				<th>Nama Customer</th>
				<td><?php echo $detail->nm_shipper ?></td>
			</tr>
			<tr>
				<th>Nama Alias</th>
		...
		<hr/>
                <div class="form-group ml-2">
                    <a href="<?php echo base_url('shipper'); ?>" class="btn btn-md btn-secondary">Cancel</a>
                </div>
	</div>
</div>