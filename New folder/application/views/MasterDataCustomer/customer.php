                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                <div class="sticky">
                                <a href="<?php echo site_url('Customer/insert'); ?>" class="btn btn-lg btn-primary mb-3 mr-auto">Tambah Customer</a>
                                </div>
                                <table class="table table-bordered table-hover table-striped table-sm display nowrap" id="dataTable" width="100%" cellspacing="0">
                                    ...
                                    <?php foreach ($customer as $key => $value) : ?>
                                        <tr>
                                            <td class="fix">
                                                <a href="<?php echo site_url('Customer/update/' . $value->id_customer); ?>" class="btn btn-sm btn-warning"><i class="fa fa-pencil-alt"></i></a>
                                                <a href="<?php echo site_url('Customer/delete/' . $value->id_customer); ?>" class="btn btn-sm btn-danger"><i class="fa fa-trash"></i></a>
                                                <a href="<?php echo site_url('Customer/detail/' . $value->id_customer); ?>" class="btn btn-sm btn-secondary"><i class="fas fa-search-plus"></i></a>
                                            </td>
                                            <td><?php echo $value->id_customer ?></td>
                                            <td><?php echo $value->nm_customer ?></td>
