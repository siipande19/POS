...
<div class="container-fluid">
    ...
    <div class="card shadow mb-4">
        <div class="card-body">
            <h1 class="h4 mb-4 text-gray-800">Tambah Customer</h1>
            <hr/>
            <form action="<?php echo site_url('Customer/insert'); ?>" method="post">
                ...
                <div class="form-row">
                    ...
                    <div class="form-group col-md-3">
                        ...
                        value="<?php echo set_value('id_customer'); ?>" >
                        <?php echo form_error('id_customer', '<small class="text-danger pl-3">', '</small>'); ?>
                    </div>
                    <!-- Nama Customer -->
                    <div class="form-group col-md-3">
                        <label for="nm_customer">Nama Customer</label>
                        <input type="text" class="form-control" name="nm_customer" id="nm_customer" value="<?php echo set_value('nm_customer'); ?>">
