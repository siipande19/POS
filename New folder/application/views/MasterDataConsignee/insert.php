...
<div class="container-fluid">
    ...
    <div class="card shadow mb-4">
        <div class="card-body">
            <h1 class="h4 mb-4 text-gray-800">Tambah Consignee</h1>
            <hr/>
            <form action="<?php echo site_url('Consignee/insert'); ?>" method="post">
                ...
                <div class="form-row">
                    ...
                    <div class="form-group col-md-3">
                        ...
                        <input type="text" class="form-control" name="id_consignee" id="id_consignee"
                        value="<?php echo set_value('id_consignee'); ?>" >
                        <?php echo form_error('id_consignee', '<small class="text-danger pl-3">', '</small>'); ?>
                    </div>
                    <!-- Nama Consignee -->
                    <div class="form-group col-md-3">
                        <label for="nm_consignee">Nama Consignee</label>
                        <input type="text" class="form-control" name="nm_consignee" id="nm_consignee" value="<?php echo set_value('nm_consignee'); ?>">
