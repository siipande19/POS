...
<div class="container-fluid">
    ...
    <div class="card shadow mb-4">
        <div class="card-body">
            <h1 class="h4 mb-4 text-gray-800">Ubah Data Customer</h1>
            <hr/>
            <form action="<?php echo site_url('Customer/update/' .$data->id_customer); ?>" method="post">
                <div class="form-row">
                    <!-- ID Customer -->
                    <div class="form-group col-md-3">
                        <label for="id_customer">ID Customer</label>
                        <input type="text" class="form-control" name="id_customer" id="id_customer" value="<?php echo $data->id_customer; ?>">
                        <?php echo form_error('id_customer', '<small class="text-danger pl-3">', '</small>'); ?>
                    </div>
                    <!-- Nama Customer -->
                    <div class="form-group col-md-3">
                        <label for="nm_customer">Nama Customer</label>
                        <input type="text" class="form-control" name="nm_customer" id="nm_customer" value="<?php echo $data->nm_customer; ?>">
                        <?php echo form_error('nm_customer', '<small class="text-danger pl-3">', '</small>'); ?>
                    </div>
                    <!-- Nama Alias -->
                    <div class="form-group col-md-3">
                ...
                <div class="form-group">
                    <a href="<?php echo base_url('Customer'); ?>" class="btn btn-sm btn-secondary">Cancel</a>
