                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                <div class="sticky">
                                <a href="<?php echo site_url('MasterData/Consignee/insert'); ?>" class="btn btn-lg btn-primary mb-3 mr-auto">Tambah Consignee</a>
                                </div>
                                <table class="table table-bordered table-hover table-striped table-sm display nowrap" id="dataTable" width="100%" cellspacing="0">
                                    ...
                                    <?php foreach ($consignee as $key => $value) : ?>
                                        <tr>
                                            <td class="fix">
                                                <a href="<?php echo site_url('Consignee/detail/' . $value->id_consignee); ?>" class="btn btn-sm btn-secondary"><i class="fas fa-search-plus"> Detail</i></a>
                                            </td>
